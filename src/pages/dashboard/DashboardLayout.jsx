...
const DashboardLayout = () => {
    ...
    transition-all duration-300 shadow-xl backdrop-blur-lg 
    bg-gradient-to-r from-purple-600 to-indigo-600 
    hover:shadow-purple-500/50 hover:ring-4 hover:ring-purple-300/60 "
                >
                    <motion.div
                        whileHover={{ scale: 1.1, rotate: 5 }}
                        transition={{ type: "spring", stiffness: 300 }}
                        className="p-3 rounded-full text-white shadow-2xl bg-white/10 backdrop-blur-md"
                    >
                        <FaHome className="w-8 h-8 drop-shadow-md" />
                    </motion.div>
                </a>
